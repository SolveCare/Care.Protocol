...
class CustomPythonEventHandler(PythonEventHandler):
    ...
    def handle(self) -> Map:
        print(f'==> [eh-h-e-w-nurse-accept-lead]: {self.arguments}')
        ...
        for existing_trial in existing_trials:
            ...
            existing_trial.put("eligibleStatus", "Lead is eligible")
        ...
        if existing_leads:
            for existing_lead in existing_leads:
                existing_lead.put("eligibleStatus", "Lead is eligible")
                self.vault.update('TRIALS_SAVED', trial_filter, existing_lead, True)  
        else:
            result.put("eligibleStatus", "Lead is eligible")
...
def execute(self: HandlerExecutionContext) -> Map:
    print(f'==> [eh-h-e-w-nurse-accept-lead]: {self}')
