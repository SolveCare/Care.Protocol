    ...
    def handle(self) -> Map:
        ...
        if len(existing_trials) == 1:
            ...
            if existing_trial_status == 'NEW':
                ...
                existing_trial.put("campaigns_likes_count", existing_trial.get("campaigns_likes_count") + 1)
                print("campaigns_likes_count exclu", existing_trial.get("campaigns_likes_count"))
...
def execute(self: HandlerExecutionContext) -> Map:
    print(f'==> [e-w-broad-matching excluu]: {self}')
