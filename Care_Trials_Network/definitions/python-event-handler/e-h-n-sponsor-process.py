...
class CustomPythonEventHandler(PythonEventHandler):
    ...
    def find_questions_data(self) -> List:
        ...
        questions_data_list = self.vault.search_pageable('SPONSOR_ANSWERS', vault_filter, pagination)
        print(f'Found {len(questions_data_list)} records of SPONSOR_ANSWERS')
    ...
    def save_sponsor_answers(self, questions_data: Map):
        ...
        spons_answers = {
            ...
            'SponsorID': questions_data.get('senderNodeAddress'),
            'specialization': questions_data.get('specialization'),
            'experienceYears': questions_data.get('experienceYears'),
            'trialsConducted': questions_data.get('trialsConducted'),
            'phaseInterested': questions_data.get('phaseInterested'),
        ...
        self.cdn.save('sponsor_info', spons_answers)
        print("sponsor_info saved", spons_answers)
    ...
    def handle(self) -> Map:
        ...
        self.context.getNotificationProvider().send(
            'Congratulations!',
            'Your Physician search details have been successfully submitted.')
        print("notification sent!")
        
        print("sponsor answers-->")
