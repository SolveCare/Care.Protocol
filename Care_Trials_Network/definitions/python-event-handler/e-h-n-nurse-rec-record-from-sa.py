...
class CustomPythonEventHandler(PythonEventHandler):
    ...
    def handle(self) -> Map:
        print("Custom event handler e-h-n-nurse-rec-record-from-sa.py")
        ...
        print("==>SA-N Nurse vault_data: ", vault_data)
        ...
        print("==>SA-N Nurse data:", data)
        self.vault.save('RECORD_DATA', data)
        result.putAll(self.event_payload)

        print("e-h-n-nurse-rec-record-from-sa.py result", result)
