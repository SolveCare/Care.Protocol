...
class CustomPythonEventHandler(PythonEventHandler):
    ...
    def find_questions_data(self) -> List:
        ...
        questions_data_list = self.vault.search_pageable('SURVEY_QUESTIONS_PHYS', vault_filter, pagination)
        print(f'Found {len(questions_data_list)} records of SURVEY_QUESTIONS_PHYS')
    ...
    def save_sponsor_answers(self, questions_data: Map):
        ...
        print("sponsor answers D1DesignQ1:", questions_data.get("D1DesignQ1"))
        print("sponsor answers D1DesignQ2:", questions_data.get("D1DesignQ2"))
        print("sponsor answers D1DesignQ3:", questions_data.get("D1DesignQ3"))
        print("sponsor answers D1DesignQ4:", questions_data.get("D1DesignQ4"))
        print("sponsor answers D1DesignQ5:", questions_data.get("D1DesignQ5"))
        ...
        "D1AnalysisQ4": questions_data.get("D1AnalysisQ4"),
        ...
        "D3StaffManagementQ7": questions_data.get("D3StaffManagementQ7"),
        ...
        print("saving physician_survey", spons_answers)
        self.cdn.save('physician_survey', spons_answers)
        print("physician_survey saved", spons_answers)
...
def execute(context: HandlerExecutionContext) -> Map:
    print(f'==> [CustomPythonEventHandler save survey ques to cdn ]: {context}')
