...
class CustomPythonEventHandler(PythonEventHandler):
    ...
    def find_questions_data(self) -> List:
        ...
        questions_data_list = self.vault.search_pageable('PROFILING_QUESTIONS_TA', vault_filter, pagination)
        print(f'Found {len(questions_data_list)} records of PROFILING_QUESTIONS_TA')
    ...
    def save_ta_answers(self, questions_data: Map):
        ...
        print("saving TA", spons_answers)
        self.cdn.save('trial_admin_prof_ques', spons_answers)
        print("trial_admin_prof_ques saved", spons_answers)
...
def execute(self: HandlerExecutionContext) -> Map:
    print(f'==> [CustomPythonEventHandler save TA profiling guestion question to cdn ]: {self}')
