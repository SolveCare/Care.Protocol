...
class CustomPythonEventHandler(PythonEventHandler):
    ...
    def handle(self) -> Map:
        print(f'==> [eh-h-e-w-nurse-skip-lead-next]: {self.arguments}')
        ...
        for existing_trial in existing_trials:
            ...
            existing_trial.put("eligibleStatus", "SKIPPED")
            self.vault.update('TRIALS_SAVED', trial_filter, existing_trial, False)
